         ...
         */
            ...
            try {
                ...
                if( params.action.equals( "save" ) ) {
                    ...
                    UserPrivilege.deleteMemcache( user?.getEmail(), userPrivilege.privilege )
                }
                ...
                /* If the save fails, delete the School that has been created during the process. */
                if( params.action.equals( "save" ) ) {
                    try {
                        if( school != null ) {
                            school.delete()
