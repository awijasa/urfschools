  ...
  if( user == null ) redirect "/index.gtpl"
	...
	html.html {
	  head {
	    ...
	    link( rel: "stylesheet", type: "text/css", href: "/css/jquery-ui-1.11.3.custom.min.css" )
...
%>
		<script type="text/javascript">
			if (typeof jQuery.ui == 'undefined') {
			    document.write(unescape("%3Cscript src='//ajax.aspnetcdn.com/ajax/jquery.ui/1.11.3/jquery-ui.min.js' type='text/javascript'%3E%3C/script%3E"));
			}
			
			if (typeof jQuery.ui == 'undefined') {
			    document.write(unescape("%3Cscript src='/js/jquery-ui-1.11.3.min.js' type='text/javascript'%3E%3C/script%3E"));
			}
		</script>
<%
